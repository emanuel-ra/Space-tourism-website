  ...
  return (
    <article className="w-full grid grid-cols-1 lg:grid-cols-2 px-10 py-5 lg:p-24 lg:h-[70vh] font-barlow text-center lg:text-left mt-24 lg:mt-0">
      ...
      <article className="flex items-center justify-center">
        <div className="flex items-center rounded-full w-[10rem] h-[10rem] md:w-[20rem] md:h-[20rem] lg:w-[22rem] lg:h-[22rem] lg:p-10 hover:bg-white/25 hover:backdrop-blur-sm ">
